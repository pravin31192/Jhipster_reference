...
describe('Service Tests', () => {
    describe('EmployeeSalary Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new EmployeeSalary(0, 0, 'AAAAAA', 'AAAAAA', 0, 0, currentDate, currentDate, 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a EmployeeSalary', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        createdAt: currentDate.format(DATE_FORMAT),
                ...
                service
                    .create(new EmployeeSalary(null))
                    .pipe(take(1))
            ...
            it('should update a EmployeeSalary', async () => {
                const returnedFromService = Object.assign(
                    {
                        employeeId: 1,
                        salary: 1,
            ...
            it('should return a list of EmployeeSalary', async () => {
                const returnedFromService = Object.assign(
                    {
                        employeeId: 1,
                        salary: 1,
            ...
            it('should delete a EmployeeSalary', async () => {
