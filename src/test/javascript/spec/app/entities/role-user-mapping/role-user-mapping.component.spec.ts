...
import { RoleUserMappingComponent } from 'app/entities/role-user-mapping/role-user-mapping.component';
...
describe('Component Tests', () => {
    describe('RoleUserMapping Management Component', () => {
        let comp: RoleUserMappingComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RoleUserMappingComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.roleUserMappings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
