...
public class Project implements Serializable {
    ...
    public Project clientCode(String clientCode) {
    ...
    public Project billableValue(Float billableValue) {
    ...
    public Project noOfResources(Integer noOfResources) {
    ...
    public Project estimatedStaffHours(Float estimatedStaffHours) {
    ...
    public Project actualStaffHours(Float actualStaffHours) {
    ...
    public Project percentageComplete(Float percentageComplete) {
    ...
    public Project deliverables(String deliverables) {
    ...
    public Project attachments(String attachments) {
    ...
    public Project updatedAt(LocalDate updatedAt) {
