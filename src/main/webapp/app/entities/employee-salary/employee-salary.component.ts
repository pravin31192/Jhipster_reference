...
export class EmployeeSalaryComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.employeeSalaryService
            ...
            .subscribe(
                (res: HttpResponse<IEmployeeSalary[]>) => this.paginateEmployeeSalaries(res.body, res.headers),
    ...
    trackId(index: number, item: IEmployeeSalary) {
        return item.id;
    }

    registerChangeInEmployeeSalaries() {
        this.eventSubscriber = this.eventManager.subscribe('employeeSalaryListModification', response => this.loadAll());
    }
    ...
    protected paginateEmployeeSalaries(data: IEmployeeSalary[], headers: HttpHeaders) {
